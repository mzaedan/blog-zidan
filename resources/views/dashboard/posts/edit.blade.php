...
<div class="col-lg-8">
  <form method="POST" action="{{ url('dashboard/posts/'.$post->slug) }}" class="mb-5" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control is-invalid" id="title" name="title" required autofocus value="{{ old('title', $post->title) }}">
      @error('title')
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control is-invalid" id="slug" name="slug" required autofocus value="{{ old('slug', $post->slug) }}">
      @error('slug')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
